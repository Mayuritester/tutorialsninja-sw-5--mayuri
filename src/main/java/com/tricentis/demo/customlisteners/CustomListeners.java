...
//        String screenshotPath = takeScreenShot("aaa");
//        test.addScreenCaptureFromPath(screenshotPath);
    ...
    public void onStart(ITestContext iTestContext) {
        reporter = new ExtentSparkReporter(System.getProperty("user.dir") + "/test-output/extent.html"); //extent.html is file name abd text-otput is folder name
